...
describe.only('esDiezOCinco(num)', function() {
...
describe.only('estaEnRango(num)', function() {
...
describe.only('esEntero(num)', function() {
...
describe.only('esPrimo(num)', function() {
...
describe.only ('esVerdadero(valor)', function() {
