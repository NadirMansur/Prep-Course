...
describe.only('devolverPrimerElemento(arr)', function() {
...
describe.only('devolverUltimoElemento(arr)', function() {
...
describe.only('obtenerLargoDelArray(arr)', function() {
...
describe.only('incrementarPorUno(arr)', function() {
...
describe.only('agregarItemAlFinalDelArray(arr, item)', function() {
...
describe.only('agregarItemAlComienzoDelArray(arr, item)', function() {
...
describe.only('dePalabrasAFrase(words)', function() {
...
describe.only('agregarNumeros(numbers)', function() {
...
describe.only('promedioResultadosTest(testScores)', function() {
...
describe.only('multiplicarArgumentos()', function () {
...
describe.only('cuentoElementos(arreglo)', function() {
...
describe.only('diaDeLaSemana(numeroDeDia)', function() {
...
describe.only('empiezaConNueve(n))', function() {
...
describe.only('todosIguales(arreglo)', function() {
...
describe.only('mesesDelAño(array)', function() {
