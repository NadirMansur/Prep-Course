...
describe.only('invocarMetodo(object, method)', function() {
...
describe.only('multiplicarNumeroDesconocidoPorCinco(mysteryNumberObject)', function() {
...
describe.only('nuevoUsuario(nombre, email, password)', function() {
...
describe.only('tieneEmail(user)', function() {
...
describe.only('tienePropiedad(object, property)', function() {
...
describe.only('actualizarPassword(user, password)', function() {
...
describe.only('agregarAmigo(user, newFriend)', function() {
...
describe.only('pasarUsuarioAPremium(users)', function() {
